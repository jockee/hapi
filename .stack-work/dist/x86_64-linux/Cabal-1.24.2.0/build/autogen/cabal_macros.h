...
/* package hapi-0.1.0.0 */
#define VERSION_hapi "0.1.0.0"
#define MIN_VERSION_hapi(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "hapi-0.1.0.0-HDb2dRPam685WlpuZhxo5t"

#define CURRENT_PACKAGE_KEY "hapi-0.1.0.0-HDb2dRPam685WlpuZhxo5t"
